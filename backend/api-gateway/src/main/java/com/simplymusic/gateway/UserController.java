...
public class UserController {
    ...
    public Map<String, Object> getUser(@AuthenticationPrincipal OAuth2User oauth2User) {
        ...
        if (oauth2User != null) {
            ...
            if (userDetails.get("preferred_username") == null) {
                Object fallback = oauth2User.getAttribute("name");
                if (fallback == null) fallback = oauth2User.getAttribute("sub");
                userDetails.put("preferred_username", fallback);
            }
        }
        return userDetails;
    }
