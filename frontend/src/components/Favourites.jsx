  ...
  return (
    <div className="flex flex-col gap-8 pb-32">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-dark-muted">The tracks you love the most.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass rounded-3xl p-16 text-center">
          <HeartCrack className="w-16 h-16 text-dark-muted mx-auto mb-4 opacity-50" />
          <h3 className="text-2xl font-bold mb-2">No favourites yet</h3>
          <p className="text-dark-muted">Go to your library and heart some tracks!</p>
        </div>
      ) : (
